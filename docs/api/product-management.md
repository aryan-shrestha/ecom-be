...
| `POST /admin/products/{id}/images` | `products:media_write` | Add product image |
...
Add an image to a product. Images are automatically positioned based on insertion order.
